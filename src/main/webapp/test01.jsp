...
<body>
	...
	<form action="test02.jsp">
		...
		<input type="text" id="sample6_address"  name = "addr"  placeholder="주소" required><br>
	...
	<script>
		function sample6_execDaumPostcode() {
			...
			session.setAttribute("postcode", data.zonecode);
			session.setAttribute("addr", addr);
			//session.setAttribute("detailAddr", data.zonecode);
		}
	</script>
